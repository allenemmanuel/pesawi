import { playersPerSide, type Discipline, type GameScore, type PingPongMatch, type SideSnapshot } from "./types";
...
export function analyzeMatch(match: PingPongMatch): MatchAnalysis {
